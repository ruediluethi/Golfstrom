...
\begin{document}
	...
	\abstract{In diesem Bericht wird der Golfstrom als mathematisches Modell dargestellt. Mit diesem Modell werden Gleichgewichtsuntersuchungen und Stabilitätsanalysen durchgeführt. Abschließend untersuchen wir das Verhalten des Golfstroms anhand von realen Werten und analysieren was passiert, wenn es zu einer Klimaerwärmung kommt und die Arktis zu schmelzen beginnt oder inwiefern sich die Jahreszeiten auf den Golfstrom auswirken.}
